...
import (
	...
	"knative.dev/reconciler-test/test/logging"
)

// NewEnvironment create a new standard test environment.
func NewEnvironment() environment.GlobalEnvironment {
	...
	return environment.NewGlobalEnvironment(ctx)
}
